...
#Purpose: To create AZ methods use information and population dataframe for WaDE_QA 2.0.
#Notes:
...
outdf.ApplicableResourceTypeCV = "Groundwater"
...
outdf.MethodName = "Arizona Water Rights"

outdf.MethodNEMILink = "http://gisdata-azwater.opendata.arcgis.com/"
