...
#Purpose: To extract OR water source use information and populate dataframe for WaDE_QA 2.0.
#Notes:
...
outdf['WaterSourceName'] = df['in_WaterSourceName']  # See preprocessing
