...
#Purpose: To extract SD water right information and population dataframe for WaDE_QA 2.0.
...
print("MethodUUID")
outdf['MethodUUID'] = "SD_Water Allocation"

print("OrganizationUUID")
outdf.OrganizationUUID = "SDDENR"
...
outdf['AllocationLegalStatusCV'] = df_DM['input_Status']
...
outdf['AllocationOwner'] = df_DM['WaDEOwner']
...
outdf['BeneficialUseCategory'] = df_DM.apply(lambda row: assignBeneficialUseCategory(row['input_Benuse']), axis=1)
