...
#Purpose: To create TX site specific reservoir and observation site use information and population dataframe for WaDEQA 2.0.
...
outdf['WaterSourceUUIDs'] = "TXssro_WS1"
