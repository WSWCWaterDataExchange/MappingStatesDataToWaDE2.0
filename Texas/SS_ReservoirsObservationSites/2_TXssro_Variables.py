...
# Purpose: To create TX site specific reservoir and observation site variable use information and population dataframe for WaDE_QA 2.0.
# Notes: N/A
...
outdf.VariableSpecificUUID = ["TXssro_V1", "TXssro_V2"]

outdf.AggregationInterval = "1"

outdf.AggregationIntervalUnitCV = "Daily"

outdf.AggregationStatisticCV = "WaDE_Unspecified"

outdf.AmountUnitCV = ["FT", "AF"]

outdf.MaximumAmountUnitCV = ["FT", "AF"]

outdf.ReportYearStartMonth = "1"

outdf.ReportYearTypeCV = "CalendarYear"

outdf.VariableCV = ["Reservoir Level", "Reservoir Storage"]

outdf.VariableSpecificCV = ["Reservoir Level_Daily_Storage_Surface Water", "Reservoir Storage_Daily_Storage_Surface Water"]
