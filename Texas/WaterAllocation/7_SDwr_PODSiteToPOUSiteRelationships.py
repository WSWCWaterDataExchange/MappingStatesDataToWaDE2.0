...
# Purpose: To extract TX site POD and POU relation information and populate dataframe for WaDEQA 2.0.
# Notes: N/A
...
workingDir = "C:/Users/rjame/Documents/WSWC Documents/MappingStatesDataToWaDE2.0/Texas/WaterAllocation"  # Specific to my machine, will need to change.
os.chdir(workingDir)
