...
# Purpose: To create CA site specific reservoir and observation site amount use information and population dataframe WaDE_QA 2.0.
# Notes:  N/A
...
os.chdir(workingDir)
M_fileInput = "RawinputData/P_caSSROMain.zip"
...
WaterSourceUUIDdict = pd.Series(dfws.WaterSourceUUID.values, index = dfws.WaterSourceNativeID).to_dict()
...
outdf['DataPublicationDate'] = "03/27/2023"
...
outdf['PrimaryUseCategory'] = df_DM['in_BeneficialUseCategory']
