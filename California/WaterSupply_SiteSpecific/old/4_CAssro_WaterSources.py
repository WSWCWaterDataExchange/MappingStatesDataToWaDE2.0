...
# Purpose: To create CA site specific reservoir and observation site water source use information and population dataframe for WaDE_QA 2.0.
# Notes: N/A
...
os.chdir(workingDir)
fileInput = "RawinputData/P_caSSROMain.zip"
