...
# Purpose: To extract CA regulatory overlay bridge to site information and populate a dataframe WaDEQA 2.0.
# Notes: 1) asdf
...
M_fileInput = "RawinputData/CA_Sites_RegulatoryOverlay_Bridge_input.csv"  # ArcGIS Pro generated input file.
...
df_regToSite['RegulatoryOverlayUUID'] = df_DM.apply(lambda row: retrieveRegulatoryOverlayUUID(row['Basin_Subb']), axis=1)
