...
# Purpose: To extract CA regulatory overlay information and populate a dataframe WaDEQA 2.0.
# Notes: N/A
...
outdf['DataPublicationDate'] = "08/26/2021"
...
outdf['RegulatoryOverlayUUID'] = df_DM.apply(lambda row: retrieveRegulatoryOverlayUUID(row['Basin_Subbasin_Number']), axis=1)

print("ReportingUnitUUID")  # Using ReportingUnitName to identify ID
outdf['ReportingUnitUUID'] = df_DM.apply(lambda row: retrieveReportingUnitsUUID(row['Basin_Subbasin_Number']), axis=1)
