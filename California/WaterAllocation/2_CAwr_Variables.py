...
# Purpose: To extract CA  information and populate dataframe for WaDE_QA 2.0.
# Notes: N/A
...
outdf.VariableSpecificUUID = ["CAwr_V1", "CAwr_V2"]
...
outdf.AmountUnitCV = ["CFS", "AF"]

outdf.MaximumAmountUnitCV = ["CFS", "AF"]
