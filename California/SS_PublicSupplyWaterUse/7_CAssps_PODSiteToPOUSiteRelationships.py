...
#Purpose: To create CA site specific public supply site POD and POU relation information and populate dataframe for WaDEQA 2.0.
...
workingDir = "G:/Shared drives/WaDE Data/California/SS_PublicSupplyWaterUse" # Specific to my machine, will need to change.
os.chdir(workingDir)
