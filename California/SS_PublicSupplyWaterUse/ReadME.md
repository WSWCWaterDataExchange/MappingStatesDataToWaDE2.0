...
- California Site Specific Public Supply Data: https://drive.google.com/drive/folders/1Q5qCreoYhKy7AVgSoG3d0OKVoPMFXVa-
...
The following text summarizes the process used by the WSWC staff to prepare and share CSWRCB's site specific time series water data for inclusion into the Water Data Exchange (WaDE 2.0) project.  For a complete mapping outline, see *CA_SS_PublicSupplyWaterUse Schema Mapping to WaDE.xlsx*.  Six executable code files were used to extract the state agency's site specific time series data from the above mentioned input files.  Each code file is numbered for order of operation.  The first code file (pre-process) was built and ran within [Jupyter Notebooks](https://jupyter.org/), the remaining five code files were built and operated within [Pycharm Community](https://www.jetbrains.com/pycharm/). The last code file *(SiteSpecificAmounts)* is dependent on the previous files.  Those six code files are as follows...

- 0_PreProcessCASSPublicSupplyWaterUseData.ipynb
- 1_CAssps_Methods.py
- 2_CAssps_Variables.py
- 3_CAssps_Organizations.py
- 4_CAssps_WaterSources.py
- 5_CAssps_Sites.py
- 6_CAssps_SiteSpecificAmounts_fact.py
- 7_CAssps_PODSiteToPOUSiteRelationships.py



***
### 0) Code File: 0_PreProcessCASSPublicSupplyWaterUseData.ipynb
...
***
### 1) Code File: 1_CAssps_Methods.py
...
---------- | ---------- | ------------
CAssps_M1 | Surface Ground Storage | Self Reported



***
### 2) Code File: 2_CAssps_Variables.py
...
---------- | ---------- | ------------ | ------------
CAssps_V1 | 1 | Unspecified | G



***
### 3) Code File: 3_CAssps_Organizations.py
...
---------- | ---------- | ------------ | ------------
CAssps_O1 | California State Water Resources Control Board | Greg Gearheart | https://www.waterboards.ca.gov/waterrights/water_issues/programs/ewrims/



***
### 4) Code File: 4_CAssps_WaterSources.py
...
- Assign state agency info to columns.  See *CA_SS_PublicSupplyWaterUse Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
    - *WaterSourceNativeID* = see *0_PreProcessCASSPublicSupplyWaterUseData.ipynb* for specific on generation.
...
---------- | ---------- | ------------ | ------------ | ------------
CAssps_WS1 | Fresh | Unspecified | Unspecified | Groundwater
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------
CAssps_S1 | Centroid of Area | 37.73436363 | -122.0273033 | NORRIS CANYON PROPERTY OWNERS ASSN. | CA0103040 | Water Service Area
...
***
### 6) Code File: 6_CAssps_SiteSpecificAmounts_fact.py
...
- Populate output DataFrames with *WaDE Water Site Specific Public Supply Amounts* data columns.
- Assign state agency data info to columns.  See *CA_SS_PublicSupplyWaterUse Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
    - Extract *MethodUUID*, *VariableSpecificUUID*, *OrganizationUUID*, *WaterSourceUUID*, & *SiteUUID* from respective input csv files. See code for specific implementation of extraction.
    - *Amount* = *in_Amount*, see *0_PreProcessCASSPublicSupplyWaterUseData.ipynb* for specific on generation.
    - *BeneficialUseCategory* =  see *0_PreProcessCASSPublicSupplyWaterUseData.ipynb* for specific on generation.
    ...
    - *ReportYearCV* = **Year**.
    - *TimeframeStart* = *in_TimeframeStart*, see *0_PreProcessCASSPublicSupplyWaterUseData.ipynb* for specific on generation.
    - *TimeframeEnd* = *in_TimeframeEnd*, see *0_PreProcessCASSPublicSupplyWaterUseData.ipynb* for specific on generation.
- Perform error check on output DataFrames.
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------
CAssps_M1 | CAss_O1 | CAss_S2 | CAss_V1 | CAss_WS1 | 105995 | Single Family Residential | 2015 | 01/01/2015 | 12/31/2015 
...
***
### 7) Code File: 7_CAssps_PODSiteToPOUSiteRelationships.py
