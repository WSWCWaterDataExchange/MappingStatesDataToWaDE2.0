...
workingDir = "G:/Shared drives/WaDE Data/California/SS_ReservoirsGages"
os.chdir(workingDir)
fileInput = "RawinputData/P_caObsRecords.csv"
...
print("HUC12")
outdf['HUC12'] = df['in_HUC12']  # See pre-processing.

print("HUC8")
outdf['HUC8'] = df['in_HUC8']  # See pre-processing.
