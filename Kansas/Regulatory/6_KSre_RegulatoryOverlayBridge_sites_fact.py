...
# Purpose: To extract KS regulatory overlay bridge to site information and populate a dataframe WaDEQA 2.0.
# Notes: 1) asdf
...
M_fileInput = "RawinputData/KS_Sites_RegulatoryOverlay_Bridge_input.csv"  # ArcGIS Pro generated input file.
...
df_regToSite['RegulatoryOverlayUUID'] = df_DM.apply(lambda row: retrieveRegulatoryOverlayUUID(row['NAME']), axis=1)
