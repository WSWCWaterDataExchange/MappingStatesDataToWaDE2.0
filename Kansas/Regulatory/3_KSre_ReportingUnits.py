...
# Purpose: To extract KS regulatory reporting unit information and populate a dataframe for WaDEQA 2.0.
# Notes: N/A
...
os.chdir(workingDir)
fileInput = "RawinputData/P_ksRegMaster.csv"
fileInput_shape = "RawinputData/P_ksRegGeometry.csv"
...
Geometrydict = pd.Series(dfshape.geometry.values, index = dfshape.GMD_ID).to_dict()
...
outdf['ReportingUnitNativeID'] = df['GMD_ID']

print("ReportingUnitProductVersion")
outdf['ReportingUnitProductVersion'] = ""

print("ReportingUnitTypeCV")
outdf['ReportingUnitTypeCV'] = "Groundwater Management Districts"
...
print("Geometry")
outdf['Geometry'] = df.apply(lambda row: retrieveGeometry(row['GMD_ID']), axis=1)
