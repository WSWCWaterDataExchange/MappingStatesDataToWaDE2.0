...
#Purpose: To extract KS water right information and population dataframe for WaDE_QA 2.0.
...
os.chdir(workingDir)
DM_fileInput = "RawinputData/P_KansasMaster.csv"
...
print("MethodUUID")
outdf['MethodUUID'] = "KDADWR_Water Rights"

print("OrganizationUUID")
outdf.OrganizationUUID = "KDADWR"

print("SiteUUID")
outdf['SiteUUID'] = df_DM.apply(lambda row: retrieveSiteUUID(row['pdiv_id_x']), axis=1)

print("VariableSpecificUUID")
outdf['VariableSpecificUUID'] = "KDADWR_Allocation All"

print("WaterSourceUUID")
outdf['WaterSourceUUID'] = df_DM.apply(lambda row: retrieveWaterSourceUUID(row['basin']), axis=1)
...
outdf['AllocationNativeID'] = df_DM['wr_id_x'].astype(str)
...
outdf['AllocationTypeCV'] = df_DM['Right Type']

print("AllocationVolume_AF")
outdf['AllocationVolume_AF'] = df_DM["auth_quant"]

print("BeneficialUseCategory")
outdf['BeneficialUseCategory'] = df_DM.apply(lambda row: assignBeneficialUseCategory(row['BenUse']), axis=1)  # see pre-processing for details
...
outdf['DataPublicationDate'] = "01/06/2021"
