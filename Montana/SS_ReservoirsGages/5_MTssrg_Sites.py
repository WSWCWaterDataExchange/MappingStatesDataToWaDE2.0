...
#Purpose: To create MT site specific reservoir and gage site information and population dataframe for WaDEQA 2.0.
...
outdf['WaterSourceUUIDs'] = "MTssrg_WS1"  # no data to work with for ID ss water source.
