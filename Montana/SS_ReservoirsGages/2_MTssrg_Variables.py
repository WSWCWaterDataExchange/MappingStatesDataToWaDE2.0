...
#Purpose: To create MT site specific reservoir and gage variable use information and population dataframe for WaDE_QA 2.0.
...
outdf.VariableSpecificUUID = ["MTssrg_V1", "MTssrg_V2"]
...
outdf.VariableSpecificCV = ["Stream Gage_Daily_Discharge_Surface Water",
                            "Stream Gage_Daily_Stage_Surface Water"]
