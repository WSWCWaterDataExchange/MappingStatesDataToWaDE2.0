...
#Purpose: To create MT observation site use information and population dataframe for WaDEQA 2.0.
...
os.chdir(workingDir)
fileInput = "RawinputData/P_mtOSMaster.csv"
...
outdf['WaterSourceUUIDs'] = "MTos_WS1"  # no data to work with for ID ss water source.
...
print("SiteName")
outdf['SiteName'] = df['LocationName']  # See pre-processing.

print("SiteNativeID")
outdf['SiteNativeID'] = df['LocationCode']  # See pre-processing.
