...
#Purpose: To create MT observation site methods use information and population dataframe for WaDE_QA 2.0.
...
outdf.MethodDescription = "Streamgage"

outdf.MethodName = "Streamgage"
