...
#Purpose: To create MT observation site amount use information and population dataframe WaDE_QA 2.0.
...
outdf['WaterSourceUUID'] = "MTos_WS1"  # no data to work with for ID ss water source.
