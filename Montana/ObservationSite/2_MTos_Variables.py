...
#Purpose: To create MT observation site variable use information and population dataframe for WaDE_QA 2.0.
...
outdf.VariableSpecificUUID = ["MTos_V1", "MTos_V2"]
...
outdf.VariableCV = ["Stream Gage", "Stream Gage"]

outdf.VariableSpecificCV = ["Stream Gage_Daily_Discharge_Surface Water",
                            "Stream Gage_Daily_Stage_Surcace Water"]
