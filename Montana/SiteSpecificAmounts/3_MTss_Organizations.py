...
#Purpose: To create MT site specific organization use information and population dataframe for WaDE_QA 2.0.
...
workingDir = "C:/Users/rjame/Documents/WSWC Documents/MappingStatesDataToWaDE2.0/Montana/SiteSpecificAmounts"
os.chdir(workingDir)
