...
#Purpose: To create MT site specific water source use information and population dataframe for WaDE_QA 2.0.
#Notes:
...
outdf['WaterSourceNativeID'] = "WaDEID_MTWS1"  # no data to work with for ID ss water source.
