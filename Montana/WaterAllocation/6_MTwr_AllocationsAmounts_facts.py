...
#Purpose: To extract MT water right use information and populate dataframe for WaDE_QA 2.0.
...
outdf['VariableSpecificUUID'] = "MTwr_V1"
...
outdf['AllocationTypeCV'] = df_DM.apply(lambda row: assignBlankUnspecified(row['in_AllocationTypeCV']), axis=1)
...
outdf['DataPublicationDOI'] = df_DM['in_DataPublicationDOI']
