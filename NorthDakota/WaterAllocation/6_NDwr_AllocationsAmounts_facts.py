...
# Purpose: To extract ND water right information and populate dataframe for WaDE_QA 2.0.
...
os.chdir(workingDir)
DM_fileInput = "RawinputData/P_NorthDakotaMaster.zip"
