...
# North Dakota lat and long data already included and converted within state provided data.
...
print("SiteName")
outdf['SiteName'] = df.apply(lambda row: assignSiteName(row['aquifer']), axis=1)
