...
# Purpose: To extract ND water source information and populate dataframe for WaDE_QA 2.0.
# Notes: N/A
...
os.chdir(workingDir)
fileInput = "RawinputData/P_NorthDakotaMaster.zip"
