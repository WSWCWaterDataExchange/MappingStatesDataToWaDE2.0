...
# Purpose: To create NJ site specific public supply site use information and populate dataframe for WaDEQA 2.0.
# Notes: N/A
...
outdf['CoordinateMethodCV'] = "Centroid of Area"
