...
#Purpose: To extract WA water source use information and population dataframe for WaDE_QA 2.0.
...
outdf['WaterSourceTypeCV'] = df.apply(lambda row: assignWaterSourceTypeCV(row['WaRecRCWClassTypeCode']), axis=1)
