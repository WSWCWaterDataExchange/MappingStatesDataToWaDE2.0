...
# Purpose: To extract NV regulatory overlay bridge to site information and populate a dataframe WaDEQA 2.0.
# Notes: 1) asdf
...
M_fileInput = "RawinputData/NV_Sites_RegulatoryOverlay_Bridge_input.csv"  # ArcGIS Pro generated input file.
...
df_regToSite['RegulatoryOverlayUUIDs'] = df_DM.apply(lambda row: retrieveRegulatoryOverlayUUID(row['BasinID']), axis=1)
