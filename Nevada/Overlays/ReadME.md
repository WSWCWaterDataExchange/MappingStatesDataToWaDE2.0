# NVDWR Overlay Overview Data Preparation for WaDE
...
- Nevada Overlay Data: [link](https://drive.google.com/drive/folders/1QK72hc8Xu9vo6TYBRMAzuVugPEo7lVEN?usp=drive_link)


## Summary of Data Prep
The following text summarizes the process used by the WSWC staff to prepare and share the state's overlay data for inclusion into the Water Data Exchange (WaDE 2.0) project.  For a complete mapping outline, see *NVov_Overlay Info Schema Mapping to WaDE.xlsx*. Several WaDE csv input files will be created in order to extract the overlay data from the above mentioned input.  Each of these WaDE csv input files was created using the [Python](https://www.python.org/) native language, built and ran within [Jupyter Notebooks](https://jupyter.org/) environment.  Those python files include the following...
...
- **2_NVov_CreateWaDEInputFiles.ipynb**: used to create the WaDE input csv files: date.csv, organization.csv, reportingunits.csv, regulatoryoverlays.csv, regulatoryreportingunits.csv, sites.csv, etc.
- **3_NVov_WRSiteRegulatoryID.ipynb**: used to pair overlay information to water allocation information using an overlay on water allocation site information within the boundaries of the regulation.
- **4_NVov_WaDEDataAssessmentScript.ipynb**: used to evaluate the WaDE input csv files.
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------
NVov_O1 | bmcmenamy@water.nv.gov | Brian McMenamy | Nevada Division of Water Resources | 775-684-2800 | Manager of Nevada's water resources | http://water.nv.gov/index.aspx | NV
...
- Assign state agency data info to the *WaDE ReportingUnits* specific columns.  See *NVov_Overlay Info Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ 
NVov_RUnv022 | 4326 | San Emidio Desert | nv022 | - | Groundwater Basin Designations | - | NV | -
...
- Assign state agency data info to the *WaDE Water Overlays* specific columns.  See *NVov_Overlay Info Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------
NVov_ROnv142 | Office of the Nevada State Engineer | D | Alkali Spring Valley | nv142 | Designated | https://www.leg.state.nv.us/NRS/NRS-534.html#NRS534Sec037 | 7/1/1981 | Groundwater Basin Designations | Groundwater
...
---------- | ---------- | ------------ | ------------ 
8/30/2023 | NVov_O1 | NVov_ROnv033B | NVov_RUnv033B
