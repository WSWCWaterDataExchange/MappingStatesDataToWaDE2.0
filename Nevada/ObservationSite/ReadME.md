# NDWR Observation Site Data Preparation for WaDE
This readme details the process that was applied by the staff of the [Western States Water Council (WSWC)](http://wade.westernstateswater.org/) to extracting observation site stream gage time series water data made available by the [Nevada Division of Water Resources (NDWR)](http://water.nv.gov/), for inclusion into the Water Data Exchange (WaDE) project.  WaDE enables states to share data with each other and the public in a more streamlined and consistent way. WaDE is not intended to replace the states data or become the source for that data but rather to enable regional analysis to inform policy decisions and for planning purposes. 
...
- 0_PreProcessNVObservationSiteData.ipynb
- 1_NVos_Methods.py
- 2_NVos_Variables.py
- 3_NVos_Organizations.py
- 4_NVos_WaterSources.py
- 5_NVos_Sites.py
- 6_NVos_SiteSpecificAmounts_fact.py
- 7_NVos_PODSiteToPOUSiteRelationships.py



***
### 0) Code File: 0_PreProcessNVObservationSiteData.ipynb
...
---------- | ---------- | ------------
NVos_M1 | Surface Water | Measured



***
### 2) Code File: 2_NVos_Variables.py
...
---------- | ---------- | ------------ | ------------
NVos_V1 | Daily | Average | CFS



***
### 3) Code File: 3_NVos_Organizations.py
...
---------- | ---------- | ------------ | ------------
NVos_O1 | Nevada Division of Water Resources | Brian McMenamy | http://water.nv.gov



***
### 4) Code File: 4_NVos_WaterSources.py
...
- Assign state agency info to columns.  See *NV_ObservationSiteAmounts Schema Mapping to WaDE_QA.xlsx* for specific details.  Items of note are as follows...
    ...
    - *WaterSourceNativeID* = custom, see *0_PreProcessNVObservationSiteData.ipynb* for specifics.
    - *WaterSourceTypeCV* = custom, see *0_PreProcessNVObservationSiteData.ipynb* for specifics.
...
---------- | ---------- | ------------ | ------------ | ------------
NVos_WS1 | Fresh | BARTLETT CREEK | WaDENV_WS1 | Surface Water
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------
NVos_S1 | Unspecified | 41.47777 | -118.78836 | 028  N41 E28 17AADD1 | 28 | STREAM
...
***
### 6) Code File: 6_NVos_SiteSpecificAmounts_fact.py
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------
NVos_M1 | NVos_O1 | NVos_S1 | NVos_V1 | NVos_WS1 | 0.91 | Discharge | 1939 | 05/27/1939 | 05/27/1939
