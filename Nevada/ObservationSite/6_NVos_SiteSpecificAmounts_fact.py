...
#Purpose: To create NV observation site amount use information and population dataframe WaDE_QA 2.0.
...
os.chdir(workingDir)
M_fileInput = "RawinputData/P_nvOSMaster.csv"
...
outdf['VariableSpecificUUID'] = "NVos_V1"

print("OrganizationUUID")
outdf['OrganizationUUID'] = "NVos_O1"
...
outdf['BeneficialUseCategory'] = "Discharge"
...
outdf['DataPublicationDate'] = '01/26/2022'
...
outdf['PrimaryUseCategory'] = "Discharge"

print("ReportYearCV")
outdf['ReportYearCV'] = df_DM['in_ReportYearCV']   # See pre-processing.
