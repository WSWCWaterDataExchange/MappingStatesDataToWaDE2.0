...
#Purpose: To create NV site specific variable use information and population dataframe for WaDE_QA 2.0.
...
outdf.VariableSpecificCV = "ReservoirsGages_Daily_Discharge_Surface Water"
