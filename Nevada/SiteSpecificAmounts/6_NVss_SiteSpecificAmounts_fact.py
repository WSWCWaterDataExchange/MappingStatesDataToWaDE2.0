...
#Purpose: To create NV site specific site amount use information and population dataframe WaDE_QA 2.0.
...
os.chdir(workingDir)
M_fileInput = "RawinputData/P_nvSSMaster.csv"
...
outdf['VariableSpecificUUID'] = "NVss_V1"

print("OrganizationUUID")
outdf['OrganizationUUID'] = "NVss_O1"
