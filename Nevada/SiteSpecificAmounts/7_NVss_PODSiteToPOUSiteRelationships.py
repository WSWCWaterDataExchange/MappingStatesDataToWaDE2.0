...
#Purpose: To create ID site POD and POU relation information and populate dataframe for WaDEQA 2.0.
...
workingDir = "C:/Users/rjame/Documents/WSWC Documents/MappingStatesDataToWaDE2.0/Nevada/SiteSpecificAmounts"  # Specific to my machine, will need to change.
os.chdir(workingDir)
