...
#Purpose: To create NV site specific water source use information and population dataframe for WaDE_QA 2.0.
#Notes:
...
os.chdir(workingDir)
fileInput = "RawinputData/P_nvSSMaster.csv"
...
outdf['WaterSourceName'] = df['in_WaterSourceName']  # See pre-processing.
