...
outdf100['WaterSourceName']= outdf100['WaterSourceName'].fillna('Unknown')
outdf100 = outdf100.drop_duplicates(subset=['WaterSourceName'])   #'WaterSourceNativeID',
outdf100 = outdf100.reset_index(drop=True)
outdf100 = outdf100.dropna(subset=['WaterSourceName'])
outdf100 = outdf100.reset_index(drop=True)
outdf100['WaterSourceName'] = outdf100['WaterSourceName'].str.upper()
...
for ix in range(len(outdf100.index)):
    outdf100.loc[ix, 'WaterSourceUUID'] = "_".join(["WWDO",str(outdf100.loc[ix, 'WaterSourceNativeID'])])
