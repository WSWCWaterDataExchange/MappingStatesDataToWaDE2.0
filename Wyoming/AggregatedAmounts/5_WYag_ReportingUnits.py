...
fileInput_shape = "RawinputData/P_wyGeometry.csv"
...
print("Geometry")
outdf['Geometry'] = df.apply(lambda row: retrieveGeometry(row['Water Use by Basin']), axis=1)
