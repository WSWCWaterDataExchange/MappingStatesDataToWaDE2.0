...
#Purpose: To create UT site specific organization use information and population dataframe for WaDE_QA 2.0.
...
outdf.OrganizationPurview = "The Utah Division of Water Rights (UDWR) publishes its water right data on-demand."
