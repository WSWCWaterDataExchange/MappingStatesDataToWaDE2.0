...
outdf['RegulatoryDescription'] = df_DM['TYPE_DEF']

print("RegulatoryName")
outdf['RegulatoryName'] = df_DM['TYPE_DEF']

print("RegulatoryOverlayNativeID")
outdf['RegulatoryOverlayNativeID'] = df_DM['TYPE']

print("RegulatoryStatusCV")
outdf['RegulatoryStatusCV'] = "Final"

print("RegulatoryStatute")
outdf['RegulatoryStatute'] = df_DM['TYPE_DEF']

print("RegulatoryStatuteLink")
outdf['RegulatoryStatuteLink'] = ""

print("StatutoryEffectiveDate")
outdf['StatutoryEffectiveDate'] = "09/20/2020"

print("StatutoryEndDate")
outdf['StatutoryEndDate'] = ""

print("RegulatoryOverlayTypeCV")
outdf['RegulatoryOverlayTypeCV'] = "Special Provision Watersheds"
