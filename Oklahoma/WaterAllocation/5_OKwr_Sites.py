...
fileInput_shape = "RawinputData/P_OklahomaGeometry.csv"
...
outdf['WaterSourceUUIDs'] = df.apply(lambda row: retrieveWaterSourceUUID(row['STREAM_SYSTEM']), axis=1)
