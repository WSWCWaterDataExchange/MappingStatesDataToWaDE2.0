...
#Purpose: To create ID site specific reservoir and gage variable use information and population dataframe for WaDE_QA 2.0.
...
outdf.VariableSpecificCV = "Discharge Flow_Daily_Stage_Surface Water"
