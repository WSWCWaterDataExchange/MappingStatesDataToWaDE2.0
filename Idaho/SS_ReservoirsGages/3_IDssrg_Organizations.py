...
#Purpose: To create ID site specific reservoir and gage organization use information and population dataframe for WaDE_QA 2.0.
...
outdf.OrganizationContactEmail = "linda.davis@idwr.idaho.gov"
