...
#Purpose: To extract AK water right information and population dataframe for WaDE_QA 2.0.
...
workingDir = "C:/Users/rjame/Documents/WSWC Documents/MappingStatesDataToWaDE2.0/Alaska/WaterAllocation"
os.chdir(workingDir)
DM_fileInput = "RawinputData/P_AlaskaMaster.csv"
...
def retrieveWaterSourceUUID(colrowValue):
    if colrowValue == '' or pd.isnull(colrowValue):
        ...
        String1 = colrowValue
        try:
            outString = WaterSourceUUIDdict[String1]
        except:
            outString = ''
    return outString
...
print("MethodUUID")
outdf['MethodUUID'] = "AKDNR_Water Use"

print("OrganizationUUID")
outdf['OrganizationUUID'] = "AKDNR"

print("SiteUUID")
outdf['SiteUUID'] = df_DM.apply(lambda row: retrieveSiteUUID(row['wswc_SiteNativeID']), axis=1)

print("VariableSpecificUUID")
outdf['VariableSpecificUUID'] = "AKDRN_Water Allocation"

print("WaterSourceUUID")
outdf['WaterSourceUUID'] = df_DM.apply(lambda row: retrieveWaterSourceUUID(row['WATER_SOURCE_ID']), axis=1)
...
outdf['AllocationLegalStatusCV'] = df_DM['FILE_TYPE_x']

print("AllocationNativeID")  # Will use this with a .groupby() statement towards the ends.
outdf['AllocationNativeID'] = df_DM['FILE_NUMBER'].astype(str)

print("AllocationOwner")
outdf['AllocationOwner'] = df_DM['CUSTOMER_NAME_x']

print("AllocationSDWISIdentifierCV")
outdf.AllocationSDWISIdentifierCV = ""

print("AllocationPriorityDate")
outdf['AllocationPriorityDate'] = df_DM['Priority Date']
...
outdf['AllocationVolume_AF'] = df_DM['wswc_QTY']

print("BeneficialUseCategory")
outdf['BeneficialUseCategory'] = df_DM.apply(lambda row: assignBeneficialUseCategory(row['STATE_USE']), axis=1)
...
outdf['DataPublicationDate'] = "01/28/2021"

print("DataPublicationDOI")
outdf['DataPublicationDOI'] = ""

print("ExemptOfVolumeFlowPriority")
outdf['ExemptOfVolumeFlowPriority'] = "1"  # Going to allow for missing info for now.
