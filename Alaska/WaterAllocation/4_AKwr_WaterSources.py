...
#Purpose: To extract AK water source information and population dataframe for WaDE_QA 2.0.
#Notes: 1) asdf
...
outdf['WaterSourceName'] = df.apply(lambda row: assignWaterSourceName(row['WITHDRAWAL_WATER_BODY_NAME']), axis=1)
