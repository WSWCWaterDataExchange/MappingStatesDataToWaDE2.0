...
#Purpose: To extract AK organization information and population dataframe for WaDE_QA 2.0.
#Notes: asdf
...
inpVals = [
    ...
    "asdf",
    "asdf",
    "https://github.com/WSWCWaterDataExchange/MappingStatesDataToWaDE2.0/tree/master/Alaska",
