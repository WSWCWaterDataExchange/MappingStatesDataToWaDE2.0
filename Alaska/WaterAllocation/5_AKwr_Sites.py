...
#Purpose: To extract AK site information and population dataframe for WaDE_QA 2.0.
#Notes: asdf
...
os.chdir(workingDir)
fileInput = "RawinputData/P_AlaskaMaster.csv"
...
print("HUC8")
outdf["HUC8"] = df['HYDROLOGIC_UNIT_CODE']

print("Latitude")
outdf['Latitude'] = df['wswc_lat']

print("Longitude")
outdf['Longitude'] = df['wswc_long']
...
print("SiteName")
outdf['SiteName'] = df.apply(lambda row: assignSiteNativeID(row['INTAKE_NAME']), axis=1)

print("SiteNativeID")
outdf['SiteNativeID'] = df['wswc_SiteNativeID']
