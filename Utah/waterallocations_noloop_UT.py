...
#the following fields have difference between the table here (edited by DPL) and that on the schema website
...
# ToDO: We are joining 'on-left': keep all rows of master table (check if need to be refined)
