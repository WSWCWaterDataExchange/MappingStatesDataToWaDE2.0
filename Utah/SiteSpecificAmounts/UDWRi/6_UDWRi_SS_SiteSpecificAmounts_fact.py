...
#Author: Ryan James
#Purpose: To extract UT site specific site amount use information and population dataframe WaDE_QA 2.0.
#Notes:
...
outdf['WaterSourceUUID'] = "UTss_WS1"  # watersource info is unspecified at this time.

print("SiteUUID")
outdf['SiteUUID'] = df_DM.apply(lambda row: retrieveSiteUUID(row['System ID']), axis=1)

print("Amount")
outdf['Amount'] = df_DM['WaterUse'].astype(float)
...
outdf['DataPublicationDate'] = '12/16/2020'
...
outdf['PopulationServed'] = df_DM['Population'].astype(int)
...
outdf['PrimaryUseCategory'] = df_DM['BenUse']
