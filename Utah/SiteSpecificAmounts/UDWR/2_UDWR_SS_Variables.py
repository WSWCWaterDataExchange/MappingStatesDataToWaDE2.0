...
outdf.VariableSpecificUUID = ["UDWR_Site Specific Unspecified", "UDWR_Site Specific Withdrawal",
                              "UDWR_Site Specific Transfer In", "UDWR_Site Specific Transfer Out",
                              "UDWR_Site Specific Delivery", "UDWR_Site Specific Return"]
