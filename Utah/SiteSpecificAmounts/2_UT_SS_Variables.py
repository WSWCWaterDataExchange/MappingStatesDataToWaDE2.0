...
outdf.VariableSpecificUUID = ["UDWR_Site Specific", "UDWR_Site Specific", "UDWR_Site Specific", "UDWR_Site Specific", "UDWR_Site Specific"]

outdf.AggregationInterval = ["1", "1", "1", "1", "1"]

outdf.AggregationIntervalUnitCV = ["Year", "Year", "Year", "Year", "Year"]

outdf.AggregationStatisticCV = ["Cumulative", "Cumulative", "Cumulative", "Cumulative", "Cumulative"]

outdf.AmountUnitCV = ["AF", "AF", "AF", "AF", "AF"]

outdf.MaximumAmountUnitCV = ["AF", "AF", "AF", "AF", "AF"]

outdf.ReportYearStartMonth = ["1", "1", "1", "1", "1"]

outdf.ReportYearTypeCV = ["CalendarYear", "CalendarYear", "CalendarYear", "CalendarYear", "CalendarYear"]

outdf.VariableCV = ["Unspecified", "Withdrawal", "Transfer", "Delivery", "Return"]

outdf.VariableSpecificCV = ["Site Specific", "Site Specific", "Site Specific", "Site Specific", "Site Specific"]
