...
#Purpose: To create CO site specific site amount use information and population dataframe WaDE_QA 2.0.
#Notes:
...
workingDir = "C:/Users/rjame/Documents/WSWC Documents/MappingStatesDataToWaDE2.0/Colorado/SiteSpecificAmounts"
os.chdir(workingDir)
M_fileInput = "RawinputData/P_coSSMaster.csv"
...
SiteUUIDdict = pd.Series(df_sites.SiteUUID.values, index = df_sites.SiteNativeID).to_dict()
...
outdf['BeneficialUseCategory'] = df_DM["useDescr"]
...
outdf['DataPublicationDate'] = '03/09/2022'
...
print("ReportYearCV")
outdf['ReportYearCV'] = df_DM['dataMeasDate'].astype(int)
