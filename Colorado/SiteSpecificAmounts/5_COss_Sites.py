...
os.chdir(workingDir)
fileInput = "RawinputData/P_coSSMaster.csv"
...
print("Latitude")
outdf['Latitude'] = df['latdecdeg']

print("Longitude")
outdf['Longitude'] = df['longdecdeg']
...
print("SiteName")
outdf['SiteName'] = df['structureName'].astype(str)
...
print("SiteTypeCV")
outdf['SiteTypeCV'] = df['structureType']
