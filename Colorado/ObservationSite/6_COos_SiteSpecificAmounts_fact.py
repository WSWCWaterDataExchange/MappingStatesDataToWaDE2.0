...
#Purpose: To create CO observation site amount use information and population dataframe WaDE_QA 2.0.
#Notes:
...
os.chdir(workingDir)
M_fileInput = "RawinputData/P_coOSMaster.csv"
...
outdf['BeneficialUseCategory'] = "DivTotal"
...
outdf['PrimaryUseCategory'] = "DivTotal"
