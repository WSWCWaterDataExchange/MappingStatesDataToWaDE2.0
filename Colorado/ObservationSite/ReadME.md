# CODWR Observation Site Data Preparation for WaDE
This readme details the process that was applied by the staff of the [Western States Water Council (WSWC)](http://wade.westernstateswater.org/) to extracting observation site stream time series water data made available by the [Colorado Division of Water Resources (CODWR)](https://dwr.colorado.gov/about-us/contact-us/denver-office), for inclusion into the Water Data Exchange (WaDE) project.  WaDE enables states to share data with each other and the public in a more streamlined and consistent way. WaDE is not intended to replace the states data or become the source for that data but rather to enable regional analysis to inform policy decisions and for planning purposes. 
...
The following text summarizes the process used by the WSWC staff to prepare and share CODWR's site specific time series water data for inclusion into the Water Data Exchange (WaDE 2.0) project.  For a complete mapping outline, see *CO_ObservationSiteAmounts Schema Mapping to WaDE_QA.xlsx*.  Six executable code files were used to extract the state agency's site specific time series data from the above mentioned input files.  Each code file is numbered for order of operation.  The first code file (pre-process) was built and ran within [Jupyter Notebooks](https://jupyter.org/), the remaining five code files were built and operated within [Pycharm Community](https://www.jetbrains.com/pycharm/). The last code file *(SiteSpecificAmounts)* is dependent on the previous files.  Those six code files are as follows...

- 0_PreProcessCOObservationSiteData.ipynb
- 1_COos_Methods.py
- 2_COos_Variables.py
- 3_COos_Organizations.py
- 4_COos_WaterSources.py
- 5_COos_Sites.py
- 6_COos_SiteSpecificAmounts_fact.py
- 7_COos_PODSiteToPOUSiteRelationships.py


***
### 0) Code File: 0_PreProcessCOObservationSiteData.ipynb
...
- Export output dataframe as new csv file, *P_coOSMaster.csv*.



***
### 1) Code File: 1_COos_Methods.py
...
---------- | ---------- | ------------
COos_M1 | Surface Ground Water | Water Use



***
### 2) Code File: 2_COos_Variables.py
...
***
### 3) Code File: 3_COos_Organizations.py
...
---------- | ---------- | ------------ | ------------
COos_O1 | Colorado Division of Water Resources| Doug Stenzel | https://dwr.colorado.gov/about-us/contact-us/denver-office



***
### 4) Code File: 4_COos_WaterSources.py
...
- Assign state agency info to columns.  See *CO_ObservationSiteAmounts Schema Mapping to WaDE_QA.xlsx* for specific details.  Items of note are as follows...
    - *WaterSourceName* = **WaterSourceName**.
    - *WaterSourceNativeID* = *in_WaterSourceNativeID*, see *0_PreProcessCOObservationSiteData.ipynb* for specifics.
...
- Assign state agency info to columns.  See *CO_ObservationSiteAmounts Schema Mapping to WaDE_QA.xlsx* for specific details.  Items of note are as follows...
    ...
    - *SiteNativeID* = *in_SiteNativeID*, see *0_PreProcessCOObservationSiteData.ipynb* for specifics.
...
---------- | ---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------
COos_S1 | COos_WS1 | Unspecified | 40.317282| -104.376767 | CORONA RANCH DITCH | WaDECO_S1 | DITCHo
...
***
### 6) Code File: 6_COos_SiteSpecificAmounts_fact.py
...
- Assign state agency data info to columns.  See *CO_ObservationSiteAmounts Schema Mapping to WaDE_QA.xlsx* for specific details.  Items of note are as follows...
    - Extract *MethodUUID*, *VariableSpecificUUID*, *OrganizationUUID*, *WaterSourceUUID*, & *SiteUUID* from respective input csv files. See code for specific implementation of extraction.
    - *Amount* = **dataValue**.
    - *BeneficialUseCategory* = **useDescr**.
    - *ReportYearCV* = **dataMeasDate**.
    - *TimeframeStart* = 01/01/ + **dataMeasDate**.  See *0_PreProcessCOObservationSiteData.ipynb* for specific on generation.
    - *TimeframeEnd* = 12/31/ + **dataMeasDate**.  See *0_PreProcessCOObservationSiteData.ipynb* for specific on generation.
- Perform error check on output dataframe.
...
---------- | ---------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------
COos_M1| COos_O1 | COos_S1 | COos_V11 | COos_WS1 | 971.92 | DivTotal | 1974 | 1/1/1974 | 12/31/1974
