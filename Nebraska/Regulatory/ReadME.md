# Nebraska Natural Resources Districts Regulatory Overview Data Preparation for WaDE
This readme details the process that was applied by the staff of the [Western States Water Council (WSWC)](http://wade.westernstateswater.org/) to extracting regulatory overlay area data, made available by the [Nebraska Natural Resources Districts](https://www.nrdnet.org/), for inclusion into the Water Data Exchange (WaDE) project.  WaDE enables states to share data with each other and the public in a more streamlined and cost-effective way.
...
- Nebraska Natural Resources Districts Regulatory Data: [link](https://drive.google.com/drive/folders/1PxFVgsiCNj4nrwOj_DhRQUojDJfQa2hq)


## Summary of Data Prep
The following text summarizes the process used by the WSWC staff to prepare and share the state's water rights data for inclusion into the Water Data Exchange (WaDE 2.0) project.  For a complete mapping outline, see *NEre_RegulatoryInfo Schema Mapping to WaDE.xlsx*. Several WaDE csv input files will be created in order to extract the water rights data from the above mentioned input.  Each of these WaDE csv input files was created using the [Python](https://www.python.org/) native language, built and ran within [Jupyter Notebooks](https://jupyter.org/) environment.  Those python files include the following...

- **1_NEre_PreProcessRegulatoryData.ipynb**: used to pre-processes the native date into a WaDE format friendly format.  All datatype conversions occur here.
- **2_NEre_CreateWaDEInputFiles.ipynb**: used to create the WaDE input csv files: date.csv, organization.csv, reportingunits.csv, regulatoryoverlays.csv, regulatoryreportingunits.csv, sites.csv, etc.
- **3_NEre_WRSiteRegulatoryID.ipynb**: used to pair regulatory overlay information to water allocation information using an overlay on water allocation site information within the boundaries of the regulation.
- **4_NEre_WaDEDataAssessmentScript.ipynb**: used to evaluate the WaDE input csv files.


***
## Code File: 1_NEre_PreProcessRegulatoryData.ipynb
...
- Use provided dictionary to attach additional regulatory status web link information based on **OBJECTID** UD input of shp file (see file for specifics).
...
- Assign state agency data info to the *WaDE ReportingUnits* specific columns.  See *NEre_RegulatoryInfo Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
    - *ReportingUnitUUID* = "NEre_RE" + **NRD_Num** input.
    - *EPSGCodeCV* = 4326.
...
- Assign state agency data info to the *WaDE Water Regulatory Overlays* specific columns.  See *NEre_RegulatoryInfo Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
    - *RegulatoryOverlayUUID* = "NEre_RO" + **NRD_Num** input.
    ...
    - *RegulatoryStatue* = ""
    - *RegulatoryStatuteLink* = see 1_NEre_PreProcessRegulatoryData.ipynb for specifics on creation.
...
- Assign state agency data info to the *WaDE Regulatory Reportingunits* specific columns.  See *NEre_RegulatoryInfo Schema Mapping to WaDE.xlsx* for specific details.  Items of note are as follows...
...
---------- | ---------- | ------------ | ------------ 
9/7/2023 | NEre_O1 | NEre_RO23 | NEre_RUne23
