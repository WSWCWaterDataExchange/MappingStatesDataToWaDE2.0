...
#Purpose: To create NE site specific resvoir and gage use information and population dataframe for WaDEQA 2.0.
...
outdf['WaterSourceUUIDs'] = "NEssro_WS1"
