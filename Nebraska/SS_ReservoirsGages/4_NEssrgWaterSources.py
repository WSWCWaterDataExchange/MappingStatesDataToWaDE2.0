...
#Purpose: To create NE site specific resvoir and gage water source use information and population dataframe for WaDE_QA 2.0.
#Notes:
...
outdf['WaterSourceNativeID'] = "WaDENE_WS1"
