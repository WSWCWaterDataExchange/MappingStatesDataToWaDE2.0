...
#Purpose: To create NE site specific resvoir and gage methods use information and population dataframe for WaDE_QA 2.0.
...
outdf.MethodName = "Nebraska Department of Natural Resources API"

outdf.MethodNEMILink = "https://nednr.nebraska.gov/IwipApi/swagger/ui/index#/StreamGage"
