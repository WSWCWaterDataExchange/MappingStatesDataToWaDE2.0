...
# Purpose: To create NE ag reporting unit information and populate a dataframe for WaDEQA 2.0.
# Notes:
...
Geometrydict = pd.Series(dfshape.in_Geomerty.values, index = dfshape.in_ReportingUnitNativeID).to_dict()
